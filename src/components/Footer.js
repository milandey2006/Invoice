...
export default function Footer({name, email, phone, website, bank, ifsc, bankAc }) {
  return (
    <>
    <footer className="footer border-t-2 border-gray-300 pt-5">
          <ul className="flex flex-wrap items-center justify-center">
            ...
            <li><span className="font-bold">IFSC Code: </span>{ifsc}</li>
            <li><span className="font-bold">Account Number: </span>{bankAc}</li>
